Public Class SendMessageParameter
    Private Const SERVER_URL = "http://218.16.64.234:802/webservice.asmx"
    ...
    Public Sub New(Version As String, Usercode As String, Password As String, UserMessageID As String, SessionID As String, Recipients() As String, Message As String, _
                       ...
                       Simulation As Boolean, RecordLog As Boolean, AddTag As Boolean, ShowDebugInfo As Boolean,
    ...
    Public ReadOnly Property Version As String
        Get
            Return "C126367F-AAF6-49F0-9037-622A9C630FF9"
        End Get
    End Property
