...
Public Class RecieveMessageServices
    ...
    Public Sub NotifyStatus(eventID As Integer, sessionID As String, res As Int32, para1 As String)
        ...
        '若参数设置不正确,则不继续执行
        If Web.Configuration.WebConfigurationManager.ConnectionStrings("KLMessageClientDB").ConnectionString = "" OrElse _
            Web.Configuration.WebConfigurationManager.ConnectionStrings("KLMessageClientDB").ConnectionString Is Nothing OrElse _
