...
Public Class frmAssignAccount
    ...
    Private Sub frmAccountManagementvb_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        getData("Select * from fn_QueryUserAccount('" & txtAccountID.Text & "','" & txtUserName.Text & "')")
    ...
    Private Sub ToolStripdelete_Click(sender As System.Object, e As System.EventArgs) Handles ToolStripdelete.Click
        ...
        For i As Integer = RowCount To 0 Step -1
            ...
            If Not IsDBNull(DataGridView1.Rows(i).Cells("Selected").Value) AndAlso DataGridView1.Rows(i).Cells("Selected").Value = True Then
    ...
    Private Sub RefreshForm(_ds As Object)
        ...
        If Not (_ds Is Nothing) Then
            ...
            ds.Tables(0).TableName = "t_UserAccount"
            ds.Tables(0).PrimaryKey = New DataColumn() {ds.Tables(0).Columns("Usercode"), ds.Tables(0).Columns("ParrentAccountID")}
            ds.Tables(0).Columns("Usercode").DefaultValue = txtAccountID.Text
            ds.Tables(0).Columns("ParrentAccountID").DefaultValue = "请录入账号"
 
            _bindingSource.DataSource = ds.Tables("t_UserAccount")
    ...
    Private Sub 保存SToolStripButton_Click(sender As System.Object, e As System.EventArgs) Handles 保存SToolStripButton.Click
        ...
        Try
            ...
            gbLoading.Visible = True
            Me.Refresh()
            upd.BeginInvoke(ds, "Select top 0 * From t_UserAccount", Nothing, Nothing, Nothing, _
    ...
    Private Sub ToolStripdelete_ButtonClick(sender As System.Object, e As System.EventArgs)
        ...
        Using fs As New System.IO.StreamReader(FileName, System.Text.Encoding.Default)
            ...
            While Not fs.EndOfStream
                ...
                With row
                    ...
                    If ds.Tables(0).Rows.Contains(New Object() {txtAccountID.Text, data(0)}) Then
